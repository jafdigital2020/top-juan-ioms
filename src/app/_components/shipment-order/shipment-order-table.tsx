...
import { ProcessOrderTableToolbar } from "./shipment-order-table-toolbar";

export default function ShipmentOrderTable({ ordersProcessedCount }: { ordersProcessedCount: (count: number) => void }) {
